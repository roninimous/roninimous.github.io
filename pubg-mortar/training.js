...
const imageBounds = [[0, 0], [2000, 2000]]; // Adjusting to match the image resolution
...
}).setView([1000, 1000], 0); // Center the map in the middle of the image

// Add the image overlay
L.imageOverlay('https://s3.ap-southeast-2.amazonaws.com/test.goallan.com.au/training.png', imageBounds).addTo(map);
...
function calculateDistance(point1, point2) {
    ...
    const meters = distance * 2 / 2000; // Convert pixels to kilometers and then to meters
