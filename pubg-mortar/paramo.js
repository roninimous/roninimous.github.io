...
const imageBounds = [[0, 0], [3000, 3000]]; // Adjusting to match the image resolution
...
}).setView([1500, 1500], -1); // Center the map in the middle of the image

// Add the image overlay
L.imageOverlay('https://s3.ap-southeast-2.amazonaws.com/test.goallan.com.au/paramo.png', imageBounds).addTo(map);
...
function calculateDistance(point1, point2) {
    ...
    const meters = distance * 3 / 3000; // Convert pixels to kilometers and then to meters
