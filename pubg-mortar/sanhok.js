...
const imageBounds = [[0, 0], [4000, 4000]]; // Adjusting to match the image resolution
...
}).setView([2000, 2000], -1); // Center the map in the middle of the image

// Add the image overlay
L.imageOverlay('https://s3.ap-southeast-2.amazonaws.com/test.goallan.com.au/sanhok.png', imageBounds).addTo(map);
...
function calculateDistance(point1, point2) {
    ...
    const meters = distance * 4 / 4000; // Convert pixels to kilometers and then to meters
